...
| Detail | Information |
|--------|-------------|
| **Departure** | Jan 13, 2026 @ 5:45 PM (Manila → HK) |
| **Return** | Jan 19, 2026 @ 11:00 AM (HK → Manila) |
| **Duration** | 7 Days / 6 Nights |
| **Accommodation** | Hotel 1: IPUK-sponsored (3D2N) → Hotel 2: Klook booking (remaining nights) |
...
| 11:00 AM | Depart HK → Manila |

---

## 🛂 Immigration Summary (Clean Version)
...
9. [ ] Test on mobile
10. [ ] Push to main → Auto-deploy to Vercel
